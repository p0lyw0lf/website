...
pg04
![Honoka smiles while holding a camera, saying "...I borrowed my parents' camera!"](https://static.wolfgirl.dev/polywolf/blog/019dcfe4-101c-777c-8ad1-d85ecf970ed8/IMG_3135.jpeg "This thing is much too large for her lmaooo")
...
1. It is not a film camera, because those generally have wildly different (blockier) body shapes until the first EOS models, and no EOS film has that same top dial (presumably a mode-switch dial if it's digital).
2. It is not a mirrorless camera, because those never have that area between the lens and the boot (because they don't need to do anything w/ optics for their digital viewfinders).
...
![Rear panel of the T5i](https://static.wolfgirl.dev/polywolf/blog/019dcfe4-101c-777c-8ad1-d85ecf970ed8/IMG_3142.jpeg)
...
| T5                                                                                                                    | T6                                                                                                                    | T7                                                                                                                    |
| --------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| ![Rear panel of the T5](https://static.wolfgirl.dev/polywolf/blog/019dcfe4-101c-777c-8ad1-d85ecf970ed8/IMG_3141.jpeg) | ![Rear panel of the T6](https://static.wolfgirl.dev/polywolf/blog/019dcfe4-101c-777c-8ad1-d85ecf970ed8/IMG_3143.jpeg) | ![Rear panel of the T7](https://static.wolfgirl.dev/polywolf/blog/019dcfe4-101c-777c-8ad1-d85ecf970ed8/IMG_3144.jpeg) |

Just for good measure, I did in fact look at a bunch of other Canon DSLRs with similar body shapes, and indeed the T6/T7 are the only ones that match the back exactly. Unfortunately, this is where the trail runs cold. There are really are _no_ external differences remaining between the T6 & T7; the _only_ possible thing is the color of the zoom button labels, but we can't tell that from the manga, and everything else is better image sensor/software differences. So, without further evidence we cannot decide which one they used.

Fortunately, I _do_ have some evidence to show, so bear with me :) On Canon's official website, we only see them (re-?)selling the [EOS Rebel T7](https://www.usa.canon.com/shop/p/eos-rebel-t7-ef-s-18-55mm-f-3-5-5-6-is-ii?color=Black&type=New), _not_ the T6. I think this is because it's the last entry-level DSLR in their lineup, their last one before their move to mirrorless with the EOS R100 for that market segment. There was a 5-year gap between the T7's 2017 release and the R100's 2023 release, and the T7 is still being sold officially today. Meanwhile, there was only a 2-year gap between the T6's release in 2016 and the T7's release, and the T6 was discontinued immediately after the T7 started being sold. So, just speaking statistically, this camera is much more likely to be a T7, based on when the manga is set (effectively modern-day).
...
+ While I have been using the American market names this entire time, the Japanese name for this camera is [EOS Kiss x90](https://personal.canon.jp/product/camera/eos/kissx90).

With all that out of the way, I think I can pretty confidently say: **Tenichi & Honoka use a _Canon EOS Kiss x90_**. Very appropriate for a romance manga lol!
